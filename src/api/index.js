...
export function DeleteNote(id,successAction) {
    const Url = `${SERVER_BASE_URL}/note/${id}`;
    fetch(Url,
        {
            method: "DELETE",
...
export function GetTuViHangNgay(date,successAction) {
    const Url = `${SERVER_BASE_URL}/tuViHangNgay/tuViHangNgay/${date}`;
    fetch(Url,
        {
            method: "GET",
            headers: {
...
export function GetQuote(date,successAction) {
    const Url = `${SERVER_BASE_URL}/quote/quote/${date}`;
    fetch(Url,
        {
            method: "GET",
            headers: {
...
export function GetDayEvent(date,successAction) {
    const Url = `${SERVER_BASE_URL}/dayEvent/dayEvent/${date}`;
    fetch(Url,
        {
            method: "GET",
            headers: {
...
export function GetLaughStory(successAction) {
    const Url = `${SERVER_BASE_URL}/laughStory`;
    fetch(Url,
        {
            method: "GET",
            headers: {
